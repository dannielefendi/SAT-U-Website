...
<head>
    ...
    <style>
        ...
        body {
            background: linear-gradient(to right, #FF6F61, #D16D79); /* Gradient colors */
        }

        .dark body {
            background: linear-gradient(to right, #4A5568, #2D3748); /* Dark mode gradient */
        }
...
<body class="transition-all duration-500">
    <div class="min-h-screen flex flex-col">
        <!-- Navbar -->
        <nav class="navbar bg-white dark:bg-gray-800 p-4 shadow-md">
        ...
        <!-- Main Content -->
        <main class="flex-grow flex items-center justify-center text-center px-4 py-12">
            <div>
                <h1 class="text-3xl font-bold text-black dark:text-white mb-4">
                    Welcome to SAT-U!
                </h1>
                <p class="text-lg text-gray-700 dark:text-gray-400 mb-6">
                    A platform where students and administrators can connect and manage events effectively.
                </p>

                @auth
                    <p class="text-xl text-green-600 dark:text-green-400">You are logged in as {{ auth()->user()->name }}</p>
                @else
                    <p class="text-xl text-gray-700 dark:text-gray-300">Please log in or register to continue.</p>
                @endauth
            </div>
        </main>

        <!-- Footer -->
        <footer class="bg-white dark:bg-gray-800 text-center py-4 text-gray-600 dark:text-gray-400">
            <p>&copy; 2025 SAT-U. All rights reserved.</p>
        </footer>
    </div>
</body>
</html> --}}
